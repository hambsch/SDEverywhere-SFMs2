...
const deployBaseUrl = 'https://github.com/hambsch/SDEverywhere-SFMs2'
...
export async function config() {
  return {
    ...
    // of platform.
    watchPaths: ['config/**', 'Socio-EnvironmentalArchetypev9.mdl'],
